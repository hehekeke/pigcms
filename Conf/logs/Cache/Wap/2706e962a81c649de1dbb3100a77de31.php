...
<?php }else{?>
	<?php if($Dazpan['bgtype'] == 0){?>
	<body style="background:url('<?php echo $Dazpan['bg']?>')">
	<?php }else{?>
	<body>
	<img src="<?php echo $Dazpan['bg']?>" style="position: fixed;top:0;left:0;width:100%;height:100%;z-index:-1">
	<?php }?>
<?php }?>
<?php if($memberNotice != NULL): echo ($memberNotice); endif; ?>
<!--main start-->
<div class="main" >
...
<?php else: ?>
    ...
    <div id="outercont"  >
        ...
        <div id="inner-cont">
            <div id="inner" <?php if($memberNotice != NULL): ?>onclick="alert('您不能参加此活动');"<?php else: endif; ?>><img src="<?php echo RES;?>/css/guajiang/images/activity-lottery-2.png"></div>
        </div>
    </div>
    <?php  } endif; ?>
...
<div class="content">
    <div class="boxcontent boxyellow myhide result"  id="result"  >
		<div class="box">
			<div class="title-orange"><span>填写中奖信息</span></div>
			<div class="Detail">   
				<p>你中了：<span class="red prizetype"><?php echo ($Dazpan["prize"]); ?>等奖</span></p>
				<p>兑奖<?php echo ($Dazpan["renamesn"]); ?>：<span class="red sncode"><?php echo ($Dazpan["sn"]); ?></span></p>
				...
				<input name=""  id="wechaid" value="<?php echo ($wecha_id); ?>" type="hidden">
				<input name=""  id="lid" value="<?php echo ($Dazpan["lid"]); ?>" type="hidden">
				<input name=""  id="rid" value="" type="hidden">
				</p>
				<p>
	...
	<?php if($record != ''): ?><div class="boxcontent boxyellow" >
		<div class="box">
			...
			>
				...
				<p>兑奖<?php echo ($Dazpan["renamesn"]); ?>：<span class="red"><?php echo ($v["sn"]); ?></span></p>
...
<div class="boxcontent boxyellow">
    <div class="box">
        ...
        <p>活动时间:<?php echo (date("Y-m-d H:i",$Dazpan["statdate"])); ?>至<?php echo (date("Y-m-d H:i",$Dazpan["enddate"])); ?></p>		
...
running = true;
    ...
    i = 10;
<?php if($memberNotice == NULL): ?>$("#inner").click(function() {
       ...
       $.ajax({
		 type:"POST",
         url     : "/index.php?g=Wap&m=Lottery&a=getajax&token=<?php echo ($Dazpan["token"]); ?>",
         dataType: "json",
         data:{
			token:"<?php echo ($Dazpan["token"]); ?>",
			wecha_id:"<?php echo ($wecha_id); ?>",
			oneid:"<?php echo ($wecha_id); ?>",
			id:'<?php echo ($Dazpan["lid"]); ?>',
			fwy:'<?php echo md5($Dazpan['token'].$wecha_id.$Dazpan['lid'].'PIGCMS'.$siteUrl);?>'
		},
         beforeSend : function(){
           // running = true;
