 ...
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
   ...
   <tr>  
    ...
    <tr>
     ...
     <tr>
         <td  height="48" align="right"><strong>图灵机器人key：</strong></td>
         <td><input type="text" name="jy_tuling_key" value="<?php echo C('jy_tuling_key');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;请填写您的图灵机器人key,例如:69d44ba63ecb29f7863ee6bbf58bfc65</span></td>

     </tr>
     <tr>
         <td  height="48" align="right"><strong>开启404本地资源：</strong></td>
         <td>
           <input type="radio" name="local_source" value="1" <?php if(C('local_source')==='1')echo checked; ?>/>开启
             <input type="radio" name="local_source" value="0" <?php if(C('local_source')!='1')echo checked; ?>/>关闭
