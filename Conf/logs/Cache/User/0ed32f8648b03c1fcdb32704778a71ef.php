...
th,td{text-align: -webkit-left;font-size:12px;}
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr class="tel"style="display:none;">
			<th align="right">一键拔号:</th>
			<td>
				<div class="mr15 l"><input id="menu_tel" class="txt" name="tel" size="60" title="一键拔号菜单" value="" type="text"><br/>一键拔号菜单  (<span style="color:red">格式：0551-65371998 或 13912345678</span>)</div>
				<div class="system l"></div>
			</td>
		</tr>
		<tr bgcolor="#F1F1F1">
