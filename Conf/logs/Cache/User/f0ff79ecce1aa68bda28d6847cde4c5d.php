...
<td>
<?php if(is_array($infos) && !empty($infos['owndomain'])): if($nomodify): ?><span class="px" style="display: inline-block;width:350px;height:24px;color:red;"><?php echo ($autodomain); ?></span>
  <?php else: ?>
  <input type="text" name="sitename" id="sitename" class="px" style="width:350px;height:24px;" value="<?php echo ($infos['owndomain']); ?>"><?php endif; ?>
<?php else: ?>
<span class="px" style="display: inline-block;width:350px;height:24px;color:red;"><?php echo ($autodomain); ?></span><?php endif; ?>
<?php if($nomodify): ?><br/>
