...
<link rel="stylesheet" type="text/css" href="<?php echo ($staticPath); ?>/tpl/static/livingcircle/css/cymain.css" />
<div class="content">
	...
	<div class="tab">
		<ul>
			<li class="tabli" id="tab1"><a href="<?php echo U('LivingCircle/index',array('token'=>$token));?>">基础信息</a></li>
			<li class="tabli" id="tab1"><a href="<?php echo U('LivingCircle/type',array('token'=>$token));?>">分类管理</a></li>
			<li class="tabli" id="tab2"><a href="<?php echo U('LivingCircle/sellcircle',array('token'=>$token));?>">商圈管理</a></li>
			<li class="current tabli" id="tab2"><a href="<?php echo U('LivingCircle/seller',array('token'=>$token));?>">商家管理</a></li>
		</ul>
	</div>
	
	<?php if($_GET['typeid'] != ''): ?><div class="cLineB">
		<h4 class="left"><?php echo ($typetitle); ?>的商家</h4>
		<div class="clr"></div>
	</div>
	<?php elseif($_GET['sellcircleid'] != ''): ?>
	<div class="cLineB">
		<h4 class="left"><?php echo ($sellcircletitle); ?>的商家</h4>
		<div class="clr"></div>
	</div>
	<?php else: ?>
	<div class="cLineB">
	...
	<div class="cLine">
		<div class="pageNavigator left">
			<a href="<?php echo U('LivingCircle/selleradd',array('token'=>$token));?>" title="添加商家" class="btnGrayS vm bigbtn">添加商家</a>
		</div>
		<div class="pageNavigator right">
			<input type="text" id="name" class="px name" placeholder="输入商家名称"  name="name" value="<?php echo ($_GET['name']); ?>" style="margin-top:10px">
	...
	<div class="msgWrap">
		<table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tbody>
				<?php if(is_array($seller_list)): $i = 0; $__LIST__ = $seller_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td><?php echo ($vo["num"]); ?></td>
					<td><?php echo ($vo["name"]); ?></td>
					<td><?php echo ($vo["phone"]); ?></td>
					<td><div class="cateimg" style="margin-left:13px"><img src="<?php echo ($vo["logourl"]); ?>" class="cateimg_small"  /><img src="<?php echo ($vo["logourl"]); ?>" class="cateimg_big"  /></div></td>
					<?php if($vo["display"] == 1): ?><td><a href="javascript:display(<?php echo ($vo["cid"]); ?>)"><img id="display<?php echo ($vo["cid"]); ?>" src="<?php echo ($staticPath); ?>/tpl/static/livingcircle/images/start.png" width="100%"/></a></td>
					<?php else: ?>
					<td><a href="javascript:display(<?php echo ($vo["cid"]); ?>)"><img id="display<?php echo ($vo["cid"]); ?>" src="<?php echo ($staticPath); ?>/tpl/static/livingcircle/images/stop.png" width="100%"/></a></td><?php endif; ?>
					<?php if($vo["recommend"] == 1): ?><td><a href="javascript:recommend(<?php echo ($vo["pigcms_id"]); ?>)"><img id="recommend<?php echo ($vo["pigcms_id"]); ?>" src="<?php echo ($staticPath); ?>/tpl/static/livingcircle/images/start.png" width="100%"/></a></td>
					<?php else: ?>
					<td><a href="javascript:recommend(<?php echo ($vo["pigcms_id"]); ?>)"><img id="recommend<?php echo ($vo["pigcms_id"]); ?>" src="<?php echo ($staticPath); ?>/tpl/static/livingcircle/images/stop.png" width="100%"/></a></td><?php endif; ?>
					<td><?php echo ($vo["loginurl"]); ?></td>
					<td class="norightborder" style="border-right:1px solid #eee">
						<a href="<?php echo U('LivingCircle/sellerupdate',array('token'=>$token,'sellerid'=>$vo['pigcms_id']));?>">修改</a>
						<a href="javascript:drop_confirm('您确定要删除【<?php echo ($vo["name"]); ?>】吗?', '<?php echo U('LivingCircle/operate',array('token'=>$token,'sellerid'=>$vo['pigcms_id'],'type'=>'sellerdel'));?>')">删除</a>
					</td>
...
<script>
	...
	function display(id){
		$.ajax({
			type:"POST",
			url:"<?php echo U('LivingCircle/ajax',array('token'=>$token));?>",
			dataType:"json",
			data:{
				type:"sellerdisplay",
				id:id,
			...
			success:function(data){
				if(data.error == 0){
					$("#display"+id).attr("src","<?php echo ($staticPath); ?>/tpl/static/livingcircle/images/stop.png");
				}else if(data.error == 1){
					$("#display"+id).attr("src","<?php echo ($staticPath); ?>/tpl/static/livingcircle/images/start.png");
				}
			}
		});
	}
	function recommend(id){
		$.ajax({
			...
			success:function(data){
				if(data.error == 0){
					$("#recommend"+id).attr("src","<?php echo ($staticPath); ?>/tpl/static/livingcircle/images/stop.png");
				}else if(data.error == 1){
					$("#recommend"+id).attr("src","<?php echo ($staticPath); ?>/tpl/static/livingcircle/images/start.png");
				}
			}
		});
	}
	function seach(){
		var name = $("#name").val();
		if(name != ""){
			window.location.href="<?php echo U('LivingCircle/seller',array('token'=>$token));?>&name="+name;
		}else{
			window.location.href="<?php echo U('LivingCircle/seller',array('token'=>$token));?>";
		}
	}
</script>
</div>
