...
$(function(){
	$('.del_confirm').click(function(){
		if(!confirm('该分类下的产品也将同时被删除。请确认：是否确认删除该分类？')){
			return false;
		}
	});
});
...
<div class="cLineB">
	<h4>产品分类管理  <span class="FAQ"></span></h4>
</div>
<div class="cLineC" style="line-height: 32px;">
	<a href="<?php echo U('Web/product',array('act'=>'product_cat_add'));?>" class="btnGrayS vm bigbtn">添加分类</a>
</div>
...
<th>分类关键词 <a target="999" class="tooltips" ><img src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><span>
<p>分类关键词是网站获取分类下产品的唯一标识</p>
</span></a></th>
                        <th style="text-align:center;">排序</th>
                        <th class="norightborder" style="text-align:center;">操作</th>
</tr>
</thead>
<?php if(is_array($news_category)): $i = 0; $__LIST__ = $news_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($vo["cat_name"]); ?></td>
<td><?php echo ($vo["cat_key"]); ?></td>
<td style="text-align:center;"><?php echo ($vo["cat_sort"]); ?></td>
<td class="norightborder" width="200" style="text-align:center;">
	<a href="<?php echo U('Web/product',array('act'=>'product_list','cat_id'=>$vo['cat_id']));?>">产品列表</a>&nbsp;&nbsp;&nbsp;
	<a href="<?php echo U('Web/product',array('act'=>'product_cat_edit','cat_id'=>$vo['cat_id']));?>">编辑</a>&nbsp;&nbsp;&nbsp;
	<a href="<?php echo U('Web/product',array('act'=>'product_cat_del','cat_id'=>$vo['cat_id']));?>" class="del_confirm">删除</a>
	</nobr>
</td>
