					...
					<tr>
						...
						<td rowspan="999" valign="top">
							<div style="margin-left:20px">
								<img id="wxpic_src" src="<?php echo ($staticPath); ?>/tpl/static/cutprice/images/wxnewspic.jpg" width="373px" >
								<br/>
								<input class="px"  name="wxpic" value="<?php echo ($staticPath); ?>/tpl/static/cutprice/images/wxnewspic.jpg" id="wxpic" style="width:363px;"  />
