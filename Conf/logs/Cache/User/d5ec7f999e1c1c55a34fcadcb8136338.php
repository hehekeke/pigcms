		...
		<div class="right" style="line-height:30px;margin:5px 0;">
		   ...
		   <select name="cardid">
          	...
          	<select name="is_weixin">
				...
				<option value="0" <?php if($is_weixin == 0): ?>selected<?php endif; ?>>普通卡券</option>
