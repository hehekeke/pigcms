...
<script type="text/javascript">
	var tpl_iframe;
	var site_url = "<?php echo ($first_pc_site); ?>";
    $(function(){
        $(".audio").mb_miniPlayer({
            width: 200,
            inLine: false,
    ...
    <div class="msgWrap bgfc">
	  <form class="form" method="post" action="" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
					<th colspan="2" style="color:red;"><div style="margin:0 0 10px;">以下为网站信息设置</div></th>
				</tr>
				<tr>
					<th width="120">网站名称：</th>
					<td><input type="text" name="site_name" value="<?php echo ($pc_config["site_name"]); ?>" class="px" style="width:350px;height:24px;"></td>
				</tr>
				<tr>
					<th>绑定域名：</th>
					<td>
					<?php echo ($pc_site); ?> &nbsp;&nbsp;
					<?php
 if ($_SERVER['HTTP_HOST']=='demo.pigcms.cn'){ echo '<span style="color:red">pigcms演示站自动分配域名，购买后可以指定任意域名</span>'; echo '<span style="display:none"><input type="text" name="pc_site" id="pc_site" value="'.$pc_site.'" class="px" style="width:350px;height:24px;"/>&nbsp;&nbsp;&nbsp;请填写域名，不支持二级目录，不包含（http://）或（/）</span>'; }else { echo '<span><input type="text" name="pc_site" id="pc_site" value="'.$pc_site.'" class="px" style="width:350px;height:24px;"/>&nbsp;&nbsp;&nbsp;请填写域名，不支持二级目录，不包含（http://）或（/）</span>'; } ?>
					</td>
					<!--td><textarea style="width:350px;height:75px" name="pc_site" id="pc_site" class="px"><?php echo ($pc_site); ?></textarea>&nbsp;&nbsp;&nbsp;一行一个域名，不支持二级目录，不包含（http://）或（/）。最多三个。</td-->
				</tr>
				<tr>
					<th>网站LOGO：</th>
					<td>
						<input type="text" name="site_logo" id="site_logo" value="<?php echo ($pc_config["site_logo"]); ?>" class="px" style="width:350px;height:24px;"/>
						<script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script>
						&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('site_logo',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('site_logo')">预览</a>
					</td>
				</tr>
				<tr>
					<th>备案信息：</th>
					<td>
						<input type="text" name="site_icp" id="site_icp" value="<?php echo ($pc_config["site_icp"]); ?>" class="px" style="width:350px;height:24px;"/>&nbsp;&nbsp;&nbsp;网站备案信息
					</td>
				</tr>
				<tr>
					<th>CNZZ统计 siteid：</th>
					<td><textarea style="width:350px;height:75px" name="site_count" id="site_count" class="px"><?php echo ($pc_config["site_count"]); ?></textarea>&nbsp;&nbsp;&nbsp;纯数字<br/><br/>CNZZ站点列表 -> 统计代码 -> 查看网址中的例如： siteid=5556057 ，则填写“5556057”<br/><br/><br/></td>
				</tr>
				<tr>
					<th colspan="2" style="color:red;"><div style="margin:0 0 10px;">以下为公司信息设置</div></th>
				</tr>
				<tr>
					<th>公司名称：</th>
					<td>
						<input type="text" name="company_name" id="company_name" value="<?php echo ($pc_config["company_name"]); ?>" class="px" style="width:350px;height:24px;"/> 
					</td>
				</tr>
				<tr>
					<th>联系QQ：</th>
					<td>
						<input type="text" name="site_qq" id="site_qq" value="<?php echo ($pc_config["site_qq"]); ?>" class="px" style="width:350px;height:24px;"/> &nbsp;&nbsp;若模板中需使用到多个QQ，请使用空格分隔。
					</td>
				</tr>
				<tr>
					<th>联系电话：</th>
					<td>
						<input type="text" name="site_phone" id="site_phone" value="<?php echo ($pc_config["site_phone"]); ?>" class="px" style="width:350px;height:24px;"/> &nbsp;&nbsp;若模板中需使用到多个电话，请使用空格分隔。
					</td>
				</tr>
				<tr>
					<th>联系邮箱：</th>
					<td>
						<input type="text" name="site_email" id="site_email" value="<?php echo ($pc_config["site_email"]); ?>" class="px" style="width:350px;height:24px;"/>
					</td>
				</tr>
				<tr>
					<th>公司地址：</th>
					<td>
						<input type="text" name="company_address" id="company_address" value="<?php echo ($pc_config["company_address"]); ?>" class="px" style="width:350px;height:24px;"/> &nbsp;&nbsp;公司/商家 地址。
					</td>
				</tr>
				<tr>
					<th colspan="2" style="color:red;"><div style="margin:20px 0;">以下为网站SEO设置</div></th>
				</tr>
				<tr>
					<th>SEO标题：</th>
					<td>
						<input type="text" name="seo_title" id="seo_title" value="<?php echo ($pc_config["seo_title"]); ?>" class="px" style="width:350px;height:24px;"/>
					</td>
				</tr>
				<tr>
					<th>SEO关键词：</th>
					<td><textarea style="width:350px;height:50px" name="seo_keywords" id="seo_keywords" class="px"><?php echo ($pc_config["seo_keywords"]); ?></textarea></td>
				</tr>
				<tr>
					<th>SEO描述：</th>
					<td><textarea style="width:350px;height:60px" name="seo_description" id="seo_description" class="px"><?php echo ($pc_config["seo_description"]); ?></textarea></td>
				</tr>
				<?php if($pc_config['other_info']): ?><tr>
						<th colspan="2" style="color:red;"><div style="margin:20px 0;">以下为您正在使用模板的私有设置项</div></th>
					</tr>
					<?php if(is_array($pc_config['other_info'])): $i = 0; $__LIST__ = $pc_config['other_info'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							<th><?php echo ($vo["name"]); ?>：</th>
							<td>
								<?php if($vo['type'] == 'text'): ?><input type="text" name="other_info[<?php echo ($key); ?>]" id="tpl_<?php echo ($key); ?>" value="<?php echo ($vo["info"]); ?>" class="px" style="width:350px;height:24px;"/><?php if($vo['tips']): ?>&nbsp;&nbsp;&nbsp;<?php echo ($vo["tips"]); endif; ?>
								<?php elseif($vo['type'] == 'textarea'): ?>	
									<textarea style="width:350px;height:50px" name="other_info[<?php echo ($key); ?>]" id="tpl_<?php echo ($key); ?>" class="px"><?php echo ($vo["info"]); ?></textarea>
									<?php if($vo['tips']): ?>&nbsp;&nbsp;&nbsp;<?php echo ($vo["tips"]); endif; endif; ?>
							</td>
