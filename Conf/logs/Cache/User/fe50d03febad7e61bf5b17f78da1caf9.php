...
<td><input type="text" name="vote_img" value='' id="pic1" class="px" style="width:350px;" >
  <a href="###" onclick="upyunPicUpload('pic1',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;&nbsp;&nbsp;(图片最佳尺寸700px*500px)&nbsp;&nbsp;&nbsp;<span id="vote_img_msg"></span></td>
</tr>
<tr>
<th width="120">图片跳转地址：</th>
<td><input type="text" name="jump_url" id="jump_url" value="" class="px" style="width:350px;"><?php if(session('isQcloud') != true): ?><a href="###" onclick="addLink('jump_url',0)" class="a_choose">从功能库添加</a><?php endif; ?>&nbsp;&nbsp;&nbsp;(如果填写,首页点击选项图片会跳转到该地址,如果不填则跳转到选项详细页)</td>
</tr>
<tr>
