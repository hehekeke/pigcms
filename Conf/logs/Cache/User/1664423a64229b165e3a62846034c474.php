				...
				<?php foreach($order_list as $vo){?>
					<tr>
						...
						<td class="norightborder" style="border-right:1px solid #eee">
							<?php if($vo['fahuo'] == 1){?>
							<a href="<?php echo U('Cutprice/operate',array('token'=>$token,'type'=>'qxfahuo','orderid'=>$vo['pigcms_id']));?>">取消发货</a>
							<?php }elseif($vo['fahuo'] == 0){?>
							<a href="javascript:fahuo(<?php echo ($vo["pigcms_id"]); ?>)">发货</a>
							<?php }else{?>
							已完成
							<?php }?>
						</td>
