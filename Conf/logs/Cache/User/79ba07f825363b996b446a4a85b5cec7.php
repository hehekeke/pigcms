...
<div class="content">
	...
	<div class="tab">
		<ul>
			...
			<li class="current tabli" id="tab1"><a href="<?php echo U('LivingCircle/type',array('token'=>$token));?>">分类管理</a></li>
	...
	<div class="cLine">
		<div class="pageNavigator left">
			<a href="<?php echo U('LivingCircle/typeadd',array('token'=>$token));?>" title="添加分类" class="btnGrayS vm bigbtn">添加分类</a>
		</div>
		<div class="pageNavigator right">
			<input type="text" id="name" class="px name" placeholder="输入分类名称"  name="name" value="<?php echo ($_GET['name']); ?>" style="margin-top:10px">
		...
		<table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tbody>
				<?php if(is_array($type_list)): $i = 0; $__LIST__ = $type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><div class="cateimg" style="margin-left:13px"><img src="<?php echo ($vo["pic"]); ?>" class="cateimg_small"  /><img src="<?php echo ($vo["pic"]); ?>" class="cateimg_big"  /></div></td>
					...
					<td class="norightborder" style="border-right:1px solid #eee">
						<a href="<?php echo U('LivingCircle/zitype',array('token'=>$token,'typeid'=>$vo['pigcms_id']));?>">子分类</a>
						<a href="<?php echo U('LivingCircle/typeupdate',array('token'=>$token,'typeid'=>$vo['pigcms_id']));?>">修改</a>
						<a href="javascript:drop_confirm('您确定要删除【<?php echo ($vo["name"]); ?>】吗?', '<?php echo U('LivingCircle/operate',array('token'=>$token,'typeid'=>$vo['pigcms_id'],'type'=>'typedel'));?>')">删除</a>
					</td>
...
<script>
	...
	function seach(){
		var name = $("#name").val();
		if(name != ""){
			window.location.href="<?php echo U('LivingCircle/type',array('token'=>$token));?>&name="+name;
		}else{
			window.location.href="<?php echo U('LivingCircle/type',array('token'=>$token));?>";
		}
	}
</script>
</div>
