...
<form class="form" method="post"   action="<?php echo U('LivingCircle/doupdate',array('token'=>$token));?>"  target="_top" enctype="multipart/form-data" >
	<div class="content">
		<div class="cLineB">
		...
		<div class="tab">
			<ul>
				<li class="current tabli" id="tab1"><a href="<?php echo U('LivingCircle/index',array('token'=>$token));?>">基础信息</a></li>
				<li class="tabli"><a href="<?php echo U('LivingCircle/type',array('token'=>$token));?>">分类管理</a></li>
				<li class="tabli" id="tab2"><a href="<?php echo U('LivingCircle/sellcircle',array('token'=>$token));?>">商圈管理</a></li>
				<li class="tabli" id="tab2"><a href="<?php echo U('LivingCircle/seller',array('token'=>$token));?>">商家管理</a></li>
			</ul>
		</div>
		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="keyword" value="<?php echo ($livingcircle["keyword"]); ?>" name="keyword" style="width:400px" />
						<br/>
						<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
					</td>
					<td rowspan="999" valign="top">
						<div style="margin-left:20px">
							<img id="wxpic_src" src="<?php echo ($livingcircle["wxpic"]); ?>" width="373px" >
							<br/>
							<input class="px"  name="wxpic" value="<?php echo ($livingcircle["wxpic"]); ?>" id="wxpic" style="width:363px;"  />
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="wxtitle" value="<?php echo ($livingcircle["wxtitle"]); ?>" name="wxtitle" style="width:400px" />
						<br/>
						请不要多于50字!
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<textarea  class="px" id="wxinfo" name="wxinfo"  style="width:400px; height:125px" ><?php echo ($livingcircle["wxinfo"]); ?></textarea>
						<br/>
						换行请输入
						&lt;br&gt;
					</td>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="fistpic"  name="fistpic" value="<?php echo ($livingcircle["fistpic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="secondpic"  name="secondpic" value="<?php echo ($livingcircle["secondpic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="thirdpic"  name="thirdpic" value="<?php echo ($livingcircle["thirdpic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="fourpic"  name="fourpic" value="<?php echo ($livingcircle["fourpic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="fivepic"  name="fivepic" value="<?php echo ($livingcircle["fivepic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="sixpic"  name="sixpic" value="<?php echo ($livingcircle["sixpic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="navpic"  name="navpic" value="<?php echo ($livingcircle["navpic"]); ?>"  style="width:250px"/>
						<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('navpic',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('navpic')">预览</a>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="mysellerpic"  name="mysellerpic" value="<?php echo ($livingcircle["mysellerpic"]); ?>"  style="width:250px"/>
						<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('mysellerpic',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('mysellerpic')">预览</a>
					</td>
				</tr>
