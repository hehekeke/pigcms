...
<td><input type="text" name="register_msg" value="<?php if($vo["follow_btn_msg"] != ''): echo ($vo["follow_btn_msg"]); echo ($vo["register_msg"]); else: ?>您好，需要您先填写个人信息才能参加活动<?php endif; ?>" class="px" style="width:550px;"></td>
</tr>
<tr>
<th>活动时间：</th>
