...
<!-- <TR>
  <th valign="top"><span class="red">*</span>活动头部图片：</th>
  <TD>
    ...
    <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic2',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a>
  </TD>
</tr> -->
<TR>
	<th><span class="red">*</span>活动时间：</th>
	<td><input type="input" class="px" id="statdate" value="<?php if($set['start'] != ''): echo (date("Y-m-d H:i",$set["start"])); else: echo ($start_date); endif; ?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" name="start" />
		到
		<input type="input" class="px" id="enddate" value="<?php if($set['end'] != ''): echo (date("Y-m-d H:i",$set["end"])); else: echo ($end_date); endif; ?>" name="end"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"  />
	</td>
</TR>
<tr>
