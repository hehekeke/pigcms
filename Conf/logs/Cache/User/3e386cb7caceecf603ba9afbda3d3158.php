...
<link href="<?php echo ($staticPath); ?>/tpl/static/yundabao/css/index.css" rel="stylesheet" type="text/css">
...
<form class="form" method="post"   action="<?php echo U('Yundabao/doadd',array('token'=>$token));?>"  target="_top" enctype="multipart/form-data">
	<div class="content" id="content1">
		<div class="cLineB">
			<h4 class="left">创建应用</h4>
		</div>
		<div class="msgWrap bgfc">
			<?php if($dingjiyuming == "pigcms.cn"){?>
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					...
					<tr>
						<th>图标颜色：</th>
						<td>
							<input type="radio" id="IconType1" value="1" name="IconType" checked />&nbsp;&nbsp;<label for="IconType1"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/5_a.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="IconType2" value="2" name="IconType" />&nbsp;&nbsp;<label for="IconType2"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/7_a.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="IconType3" value="3" name="IconType" />&nbsp;&nbsp;<label for="IconType3"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/1_a.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="IconType4" value="4" name="IconType" />&nbsp;&nbsp;<label for="IconType4"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/8_a.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="IconType5" value="5" name="IconType" />&nbsp;&nbsp;<label for="IconType5"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/4_a.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<br/>
							<input type="radio" id="IconType6" value="6" name="IconType" />&nbsp;&nbsp;<label for="IconType6"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/3_a.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="IconType7" value="7" name="IconType" />&nbsp;&nbsp;<label for="IconType7"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/2_a.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="IconType8" value="8" name="IconType" />&nbsp;&nbsp;<label for="IconType8"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/9_a.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="IconType9" value="9" name="IconType" />&nbsp;&nbsp;<label for="IconType9"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/6_a.png" width="50px"></label>
						</td>
					</tr>
					<tr>
						<th>图标名称：</th>
					...
					<tr>
						...
						<td>
							...
							<a href="###" onclick="upyunPicUpload('IconName_url',114,114,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('IconName_url')">预览</a>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="###" onclick="upyunPicUpload('LogoName_url',440,60,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('LogoName_url')">预览</a>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					...
					<tr>
						<th>选择风格：</th>
						<td>
							<input type="radio" id="BgColor1" value="1" name="BgColor" checked />&nbsp;&nbsp;<label for="BgColor1"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/bg01_s1.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="BgColor2" value="2" name="BgColor" />&nbsp;&nbsp;<label for="BgColor2"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/bg02_s1.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="BgColor3" value="3" name="BgColor" />&nbsp;&nbsp;<label for="BgColor3"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/bg03_s1.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="BgColor4" value="4" name="BgColor" />&nbsp;&nbsp;<label for="BgColor4"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/bg04_s1.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="BgColor5" value="5" name="BgColor" />&nbsp;&nbsp;<label for="BgColor5"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/bg05_s1.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="BgColor6" value="6" name="BgColor" />&nbsp;&nbsp;<label for="BgColor6"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/bg06_s1.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="BgColor7" value="7" name="BgColor" />&nbsp;&nbsp;<label for="BgColor7"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/bg07_s1.png" width="50px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="BgColor8" value="8" name="BgColor" />&nbsp;&nbsp;<label for="BgColor8"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/bg08_s1.png" width="50px"></label>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					...
					<tr>
						<th>选择欢迎图：</th>
						<td>
							<input type="radio" id="SplashType1" value="1" name="SplashType" checked />&nbsp;&nbsp;<label for="SplashType1"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/welcome1.png" width="80px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="SplashType5" value="2" name="SplashType" />&nbsp;&nbsp;<label for="SplashType5"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/welcome2.png" width="80px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="SplashType2" value="3" name="SplashType" />&nbsp;&nbsp;<label for="SplashType2"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/welcome3.png" width="80px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="SplashType3" value="4" name="SplashType" />&nbsp;&nbsp;<label for="SplashType3"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/welcome4.png" width="80px"></label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="SplashType4" value="5" name="SplashType" />&nbsp;&nbsp;<label for="SplashType4"><img src="<?php echo ($staticPath); ?>/tpl/static/yundabao/images/welcome5.png" width="80px"></label>
						</td>
					</tr>
					<tr>
						<th>自己上传欢迎图：</th>
						<td>
							...
							<a href="###" onclick="upyunPicUpload('SplashName',800,1280,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('SplashName')">预览</a>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php if($daoshi == ""){?>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo U('Yundabao/download',array('token'=>$token,'AppId'=>$_GET['AppId']));?>&filetype=ipa" target="_blank">点击下载</a>
						<?php }?>
					</td>
				</tr>
			</tbody>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php if($daoshi == ""){?>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo U('Yundabao/download',array('token'=>$token,'AppId'=>$_GET['AppId']));?>&filetype=apk" target="_blank">点击下载</a>
						<?php }?>
					</td>
				</tr>
			</tbody>
